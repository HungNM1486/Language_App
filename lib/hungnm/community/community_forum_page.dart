...
class _CommunityForumPageState extends State<CommunityForumPage> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final TextEditingController _searchController = TextEditingController();
  String _selectedFilter = 'Tất cả';
  final List<String> _filters = ['Tất cả', 'Ngữ pháp', 'Từ vựng', 'Phát âm', 'Nói', 'Viết', 'Khác'];
  
  // Mock data - sẽ thay thế bằng dữ liệu thực từ API hoặc DB
  final List<ForumPost> _mockPosts = [
    ForumPost(
      id: '1',
      title: 'Cách học từ vựng hiệu quả',
      content: 'Tôi muốn chia sẻ phương pháp học từ vựng hiệu quả mà tôi đã áp dụng và cải thiện vốn từ của mình...',
      authorName: 'Mai Anh',
    ...
    ForumPost(
      ...
      content: 'Sau một thời gian dài ôn luyện, tôi đã đạt được band điểm 7.5 IELTS. Hôm nay tôi muốn chia sẻ hành trình và kinh nghiệm của mình...',
    ...
    ForumPost(
      ...
      content: 'Tôi là người mới bắt đầu học tiếng Anh và đang phân vân giữa việc nên tập trung vào ngữ pháp trước hay nên luyện nói trước...',
      authorName: 'Thu Hà',
    ...
    ForumPost(
      ...
      content: 'Chào mọi người, tôi muốn chia sẻ một số tài liệu học tiếng Anh miễn phí mà tôi thấy rất hữu ích...',
      ...
      imageUrls: ['https://picsum.photos/id/15/800/400', 'https://picsum.photos/id/25/800/400'],
      likes: 78,
      comments: 14,
  ...
  void initState() {
    ...
    // Lắng nghe thay đổi tab để cập nhật danh sách bài viết
  ...
  void _filterPosts() {
    setState(() {
      ...
      // Lọc thêm dựa trên tab hiện tại
      if (_tabController.index == 1) {
        // Tab Phổ biến - sắp xếp theo lượt thích
        _filteredPosts.sort((a, b) => b.likes.compareTo(a.likes));
      } else if (_tabController.index == 2) {
        // Tab Đang theo dõi - giả định logic theo dõi (sẽ thực hiện sau)
        // Hiện tại đang để nguyên danh sách
      }
    });
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Pinned post (nếu có)
          if (_filteredPosts.isNotEmpty && _tabController.index == 0)
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Thông báo quan trọng: Hướng dẫn sử dụng diễn đàn',
                      style: TextStyle(
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ForumPostCard(
                          ...
                          onAuthorTap: () => _navigateToUserProfile('author-${post.id}', post.authorName),
