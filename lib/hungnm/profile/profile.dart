...
import 'package:language_app/hungnm/profile/setting/setting_screen.dart'; // Import file setting.dart
...
import 'package:language_app/hungnm/profile/friends_list_screen.dart'; // Import file friends_list_screen.dart
import 'package:language_app/hungnm/profile/courses_list_screen.dart'; // Import file courses_list_screen.dart
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.only(top: 40 * pix),
          child: Column(
            children: [
              // Nút cài đặt được đưa vào đây để cuộn theo nội dung
              Align(
                    ...
                    onPressed: () async {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                              content: Text('Đã sao chép: $inviteLink')),
                        );
                      }
                    },
                  ),
  ...
  Widget _buildLanguageAndFriendsSection(Size size, double pix) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 10 * pix, vertical: 25 * pix),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          GestureDetector(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 16 * pix,
                    fontFamily: 'BeVietnamPro',
                    color: Colors.black, // Giữ màu đen như ban đầu
                  ),
                ),
              ],
            ),
